...
@Component({
  selector: 'app-md-subscriber',
  templateUrl: './md-subscriber.component.html',
  styleUrls: ['./md-subscriber.component.scss']
})
export class MDSubscriberComponent implements OnInit {
